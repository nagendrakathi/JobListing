    ...
    <header className="relative bg-white border border-[#fcfcfc] top-[2px] rounded-full w-fit h-[80px] mx-auto my-[21px] flex items-center justify-center box-border shadow-[0_4px_10px_rgba(0,0,0,0.05)]">
      <div className=" flex items-center justify-between w-full px-[20px] ">
            ...
            (item, idx) => (
              <a
                ...
                className="w-[102px] h-[48px] rounded-[12px] px-[5px] py-[5px] flex items-center justify-center gap-[11.14px] 
                             opacity-100 text-[#303030] font-medium text-sm md:text-[16px]
        ...
        <button
          ...
          className="w-[133px] ml-3 h-[48px] rounded-full bg-gradient-to-b from-[#A128FF] to-[#6100AD] 
                       font-semibold text-sm md:text-[16px] text-white 
